export default function Home() {
    return (
        <>
            ...
            <div className="bg-[#333] p-2 mt-3 flex justify-center border-dashed border-[#808080] border-4">
                <p>
            ...
            <p className="text-center mt-2 mb-3">For other projects, like my essays or web projects, check out the <a href="/directory">directory</a>. <b>Thanks for visiting!</b></p>
            <div className="flex flex-wrap justify-center mb-3">
                ...
                <img src="https://cyber.dabamos.de/88x31/graphicdesign.gif" alt="Graphic design is my passion" />
